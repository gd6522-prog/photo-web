...
export const MENU_REGISTRY: MenuItem[] = [
  ...
  // 메인관리자만 접근/노출
  { key: "settings_permissions", label: "4. 권한 설정", href: "/admin/settings/permissions", group: "settings", order: 140, mainOnly: true },

  // ✅ 공휴일 자동 동기화(공공데이터포털)
  { key: "settings_holidays", label: "5. 공휴일 동기화", href: "/admin/settings/holidays", group: "settings", order: 150, mainOnly: true },
];
