...
export function VehiclePageScreen({
  ...
  const REPORT_PRINT_SCALE = 0.625;
  const REPORT_PRINT_SCALE_X = 1.025;
    ...
    const printMarkup = shells
      .map((shell) => {
        ...
        clone.querySelectorAll(".report-print-frame").forEach((node) => {
          ...
          frame.style.transform = `scaleX(${REPORT_PRINT_SCALE_X})`;
          ...
          <style>
            ...
            * {
            ...
            .report-print-frame {
              ...
              transform: scaleX(${REPORT_PRINT_SCALE_X}) !important;
