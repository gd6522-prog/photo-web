...
export default function AdminCalendarPage() {
  ...
  // ---- month range for query (date column 기준)
                        ...
                        {count > 0 && (
                          <span
                            style={{
                              ...
                              border: isSelected ? "1px solid #111827" : "1px solid #111827",
                              display: "flex",
                              alignItems: "center",
                              justifyContent: "center",
                              fontSize: 10,
          ...
          <div style={{ border: "1px solid #E5E7EB", borderRadius: 14, background: "white", overflow: "hidden" }}>
            ...
            <div style={{ padding: 12 }}>
              {loading ? (
                ...
                <div style={{ color: "#6B7280", fontSize: 13 }}>등록된 일정이 없습니다.</div>
              ) : (
                    ...
                    >
                      <div style={{ display: "flex", justifyContent: "space-between", gap: 10, alignItems: "flex-start" }}>
                        <div style={{ minWidth: 0 }}>
                          ...
                          {e.memo ? (
                            <div style={{ marginTop: 6, color: "#374151", fontSize: 13, whiteSpace: "pre-wrap" }}>{e.memo}</div>
                          ) : null}
                        </div>
